...
public class 读档按钮确认菜单设置 : MonoBehaviour
{
    ...
    public void SetWarningWindow()
    {
        ...
        WarningWindow.Instance.MainMSG.text = $"读取存档:{saveSysMSG.selectedSaveField.header.DMSG}";
        WarningWindow.Instance.A_MSG.text = "确认";
        WarningWindow.Instance.B_MSG.text = "返回";
        WarningWindow.Instance.A_Event.AddListener(saveSysMSG.Load);
